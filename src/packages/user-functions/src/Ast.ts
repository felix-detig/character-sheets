import { Token, TokenTypeBinaryOperator, UserFunctionContext } from './types';

// TODO shouldnt work: if {1 > 2} {1} {}
// TODO shouldnt work: 1 if {1 > 2}		(if is completely ignored, "1 if {1 >" also works)
